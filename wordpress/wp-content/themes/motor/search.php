...
<?php if ( have_posts() ) : ?>
	...
	<div class="cont maincont">
		...
		<p class="section-count"><?php echo esc_attr($products_count); ?> <?php esc_html_e('ITEMS', 'motor'); ?></p>
	...
	<div class="cont maincont">
		...
		<p class="section-count"><?php echo esc_attr($posts_count); ?> <?php esc_html_e('ITEMS', 'motor'); ?></p>
			...
			<div class="blog-cont">
				...
				while ( have_posts() ) : the_post();
					...
					if (function_exists('vp_metabox')) {
						$blog_video = vp_metabox('motor_meta_blog.blog_video');
						$blog_slider = vp_metabox('motor_meta_blog.blog_slider');
						$blog_map_ltd = vp_metabox('motor_meta_blog.blog_map_ltd');
						$blog_map_lgt = vp_metabox('motor_meta_blog.blog_map_lgt');
						$blog_map_address = vp_metabox('motor_meta_blog.blog_map_address');
						$blog_mapzoom = vp_metabox('motor_meta_blog.blog_mapzoom');
					}
					?>
	...
	<div class="cont maincont">
		...
		<p class="section-count"><?php echo esc_attr($others_count); ?> <?php esc_html_e('ITEMS', 'motor'); ?></p>
