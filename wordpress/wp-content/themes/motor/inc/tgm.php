...
function motor_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'       => esc_url('http://motor-wp.stockware.ru/demo/motor-custom-types.zip'),
			'required'     => true,
		),
		...
		array(
			...
			'slug'      => 'js_composer',
			'required'  => true,
			'source'       => esc_url('http://motor-wp.stockware.ru/demo/js_composer.zip'),
		),
		...
		array(
			...
			'required'  => false,
			'source'       => esc_url('http://motor-wp.stockware.ru/demo/revslider.zip'),
		),
		...
		array(
			'name'      => esc_html__('WooCommerce Products Filter', 'motor'),
