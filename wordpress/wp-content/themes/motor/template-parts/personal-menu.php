...
<ul class="cont-sections">
    ...
    <li<?php if (get_the_id() == $motor_options['wishlist']['id']) echo ' class="active"'; ?>>
        <a href="<?php echo ($motor_options['wishlist']['id']) ? get_permalink($motor_options['wishlist']['id']) : ''; ?>"><?php echo esc_html__('Wishlist', 'motor'); ?> <span><?php echo (!empty($motor_options['wishlist']['count'])) ? $motor_options['wishlist']['count'] : '0'; ?></span></a>
    </li>
    <?php endif; ?>
