...
$post_sidebar_position = $motor_options['motor_post_sidebar'];
...
<?php if (have_posts()) : the_post(); ?>
	...
	<div class="post-slider">
		...
		<?php foreach ($blog_slider as $blog_slide) : ?>
			...
			<li>
				<?php $img_src = wp_get_attachment_image_src( motor_get_attach_id_from_src($blog_slide['img']), 'motor_full' ); ?>
	...
	<div class="cont<?php
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class('s-post page-styling'); ?>>
			...
			// Social Share
			if (!empty($motor_options['motor_other_share'])) {
