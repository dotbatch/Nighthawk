...
$cart_template = $motor_options['motor_cart_template'];
?>
<div class="cont maincont">
	...
	<p class="section-count"><?php echo WC()->cart->get_cart_contents_count(); ?> <?php echo esc_html__('ITEMS', 'motor'); ?></p>
						...
						<div class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?> sectls prod-li">
							...
							<div class="prod-li-info">
								<div class="prod-li-rating-wrap">
									...
									<p><span class="prod-li-rating-count"><?php echo intval($_product->get_review_count()); ?></span> <?php esc_html_e('reviews', 'motor'); ?></p>
								</div>
								<p class="prod-li-id"><?php esc_html_e('id', 'motor'); ?> <?php echo intval($product_id); ?></p>
								<p class="prod-li-add">
									<?php
