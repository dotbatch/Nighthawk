...
if (function_exists('vp_metabox')) {
	$product_shipping = vp_metabox('motor_meta_product.product_shipping');
	...
	<div class="prod-cont">
		...
		<div class="prod-info">
			...
			<div class="prod-qnt-wrap">
				...
				<p class="qnt-wrap prod-qnt">
					...
					<input data-qnt-price="<?php echo esc_attr($product->get_display_price()); ?>" type="text" value="1">
		...
		<div class="prod-actions">
			<div class="prod-rating-wrap">
				...
				<p><span class="prod-rating-count"><?php echo intval($product->get_review_count()); ?></span> <?php esc_html_e('reviews', 'motor'); ?></p>
			</div>
