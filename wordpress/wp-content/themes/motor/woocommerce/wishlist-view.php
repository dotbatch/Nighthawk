...
<?php do_action( 'yith_wcwl_before_wishlist_form', $wishlist_meta ); ?>
    ...
    <p class="section-count"><?php echo count( $wishlist_items ); ?> <?php echo esc_html__('ITEMS', 'motor'); ?></p>
                    ...
                    if( $product !== false && $product->exists() ) :
                        ...
                        if ( $product->get_price() !== '' ) {
                            if ( $product->is_on_sale() ) {
                                ...
                                $price = '<span class="prod-li-price">'.esc_html__('Free!', 'motor').'</span>';
                            }
                        } else {
                            $price = '';
                        }
                        ...
                        <article <?php post_class( $classes ); ?> id="yith-wcwl-row-<?php echo intval($item['prod_id']); ?>" data-row-id="<?php echo intval($item['prod_id']); ?>">
                            ...
                            <div class="prod-li-cont">
                                ...
                                <div class="prod-li-qnt-wrap">
                                    ...
                                    <p class="qnt-wrap prod-li-qnt">
                                        ...
                                        <input type="text" value="1" data-qnt-price="<?php echo esc_attr($product->get_display_price()); ?>">
                            ...
                            <div class="prod-li-info">
                                <div class="prod-li-rating-wrap">
                                    ...
                                    <p><span class="prod-li-rating-count"><?php echo intval($product->get_review_count()); ?></span> <?php esc_html_e('reviews', 'motor'); ?></p>
                                </div>
                                <p class="prod-li-id"><?php esc_html_e('id', 'motor'); ?> <?php echo intval($product->id); ?></p>
                                <p class="prod-li-add">
