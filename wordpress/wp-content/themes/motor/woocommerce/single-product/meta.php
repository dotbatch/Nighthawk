...
<dl>
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		...
		<dt><?php esc_html_e( 'SKU:', 'motor' ); ?></dt> <dd itemprop="sku"><?php echo ( $sku = $product->get_sku() ) ? esc_attr($sku) : esc_html__( 'N/A', 'motor' ); ?></span></dd>
		<?php $props_count--; ?>

	<?php endif; ?>

	<?php if (get_the_terms( $post->ID, 'product_cat' )) : ?>
		<?php echo wp_kses_post($product->get_categories( ', ', '<dt>' . _n( 'Category:', 'Categories:', $cat_count, 'motor' ) . '</dt> <dd>', '</dd>' )); ?>
		<?php $props_count--; ?>
	<?php endif; ?>

	<?php if (get_the_terms( $post->ID, 'product_tag' )) : ?>
		<?php echo wp_kses_post($product->get_tags( ', ', '<dt>' . _n( 'Tag:', 'Tags:', $tag_count, 'motor' ) . '</dt> <dd>', '</dd>' )); ?>
		<?php $props_count--; ?>
	<?php endif; ?>
	...
	<dt><a id="prod-showprops" href="#"><?php echo esc_html__('view all details', 'motor'); ?></a></dt>
	<dd></dd>
	<?php } ?>
