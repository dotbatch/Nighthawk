...
genesis_register_sidebar( array(
	'id'          => 'below-header',
	'name'        => __( 'Call Us tag line', 'altitude' ),
	'description' => __( 'This is the Call Us tag line section.', 'altitude' ),
) );
...
function mh_footer_info() {
   $output = '<div class="copyright">Copyright [the-year] Nighthawk Machinery. All right reserved.</div>';
   echo do_shortcode( $output );
}*/
add_filter('genesis_footer_creds_text', 'sp_footer_creds_filter');
function sp_footer_creds_filter( $creds ) {
	$creds = 'Copyright [footer_copyright] Nighthawk Machinery. All right reserved.<br/> Rosenberg, TX <ul><li> Alsip, IL </li></ul>';
	return $creds;
}

add_action( 'genesis_after_header', 'below_header' );
function below_header(){
	genesis_widget_area( 'below-header', array(
            'before' => '<div class="call_us widget-area"><div class="wrap"',
            'after' => '</div></div>'
            ) );
}
