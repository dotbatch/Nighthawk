 ...
 $Accordion_Shortcode_Settings = unserialize(get_post_meta( $PostId, 'Accordion_Shortcode_Settings', true));
		...
		$option_names = array(
			...
			foreach($option_names as $option_name => $default_value) {
				if(isset($Accordion_Shortcode_Settings[$option_name])) 
					${"" . $option_name}  = $Accordion_Shortcode_Settings[$option_name];
				else
...
<input type="hidden" id="accordion_shortcode_setting_save_action" name="accordion_shortcode_setting_save_action" value="accordion_setting_save_action">
		
<table class="form-table acc_table">
	<tbody>
		
		<tr>
			<th scope="row"><label><?php _e('Display Accordion Section Title ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					...
					<label for="enable_acc_sec_title" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					...
					<label for="disable_acc_sec_title" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
				...
				<div id="acc_sec_title_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Display Accordion Section Title ',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/sec-title.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php _e('Accordion Open/Close Icon Alignment',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					...
					<label for="enable_acc_op_cl_align" class="switch-label switch-label-off"><?php _e('left',wpshopmart_accordion_shortcode_text_domain); ?></label>
					...
					<label for="disable_acc_op_cl_align" class="switch-label switch-label-on"><?php _e('right',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="acc_op_cl_align_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Open/Close Icon Alignment',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/op-cl-icon.png' ?>">
						<br>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/align.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Display Open Close Icon ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					<input type="radio" class="switch-input" name="op_cl_icon" value="yes" id="enable_op_cl_icon" <?php if($op_cl_icon == 'yes' ) { echo "checked"; } ?>  >
					<label for="enable_op_cl_icon" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<input type="radio" class="switch-input" name="op_cl_icon" value="no" id="disable_op_cl_icon"  <?php if($op_cl_icon == 'no' ) { echo "checked"; } ?> >
					<label for="disable_op_cl_icon" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="op_cl_icon_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Display Open Close Icon ',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/op-cl-icon.png'; ?>">
					</div>
		    	</div>
			</td>
		...
		<tr>
			<th scope="row"><label><?php _e('Display Accordion Title Font Icon ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					...
					<label for="enable_acc_title_icon" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					...
					<label for="disable_acc_title_icon" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="acc_title_icon_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Display Accordion Title Font Icon ',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/ft-icon.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Enable Accordion Radius ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					<input type="radio" class="switch-input" name="acc_radius" value="yes" id="enable_acc_radius" <?php if($acc_radius == 'yes' ) { echo "checked"; } ?>  >
					<label for="enable_acc_radius" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<input type="radio" class="switch-input" name="acc_radius" value="no" id="disable_acc_radius" <?php if($acc_radius == 'no' ) { echo "checked"; } ?> >
					<label for="disable_acc_radius" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="acc_radius_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Enable Accordion Radius from here',wpshopmart_accordion_shortcode_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Enable Accordion Margin/Space',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					<input type="radio" class="switch-input" name="acc_margin" value="yes" id="enable_acc_margin" <?php if($acc_margin == 'yes' ) { echo "checked"; } ?>  >
					<label for="enable_acc_margin" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<input type="radio" class="switch-input" name="acc_margin" value="no" id="disable_acc_margin"  <?php if($acc_margin == 'no' ) { echo "checked"; } ?> >
					<label for="disable_acc_margin" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="acc_margin_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Enable Accordion Margin/Space',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/margin.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Enable Toggle/Collapse ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch">
					...
					<label for="enable_acc_toggle" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					...
					<label for="disable_acc_toggle" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<!-- Tooltip -->
				...
				<div id="enable_toggle_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Enable Toggle/Collapse ',wpshopmart_accordion_shortcode_text_domain); ?></strong> very html</h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/collapse.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Title Background Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="acc_title_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Title Background Colour',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/ft-bg-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Title/Icon Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="acc_title_icon_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Title/Icon Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/title-ft-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Open/Close Icon Background Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<!-- Tooltip -->
				<a  class="ac_tooltip" href="#help" data-tooltip="#acc_open_cl_icon_bg_clr_tp">help</a>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Open/close Icon Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<!-- Tooltip -->
				<a  class="ac_tooltip" href="#help" data-tooltip="#acc_open_cl_icon_ft_clr_tp">help</a>
				<div id="acc_open_cl_icon_ft_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Title/Icon Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/op-ft-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Description Background Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="acc_desc_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Description Background Colour',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/desc-bg-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th scope="row"><label><?php _e('Accordion Description Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="acc_desc_font_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Description Font Colour',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/desc-ft-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		<tr class="setting_color">
			<th><?php _e('Title/Icon Font Size',wpshopmart_accordion_shortcode_text_domain); ?> </th>
			<td>
		...
		<tr class="setting_color">
			<th><?php _e('Description Font Size',wpshopmart_accordion_shortcode_text_domain); ?> </th>
			<td>
		...
		<tr >
			<th><?php _e('Font Style/Family',wpshopmart_accordion_shortcode_text_domain); ?> </th>
			<td>
		...
		<tr>
			<th scope="row"><label><?php _e('Expand/Collapse Accordion Option On Page Load',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="expand_option_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Expand/Collapse Accordion Option On Page Load',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/ft-bg-color.png'; ?>">
						<br>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/hide-all.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Accordion Styles',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				...
				<div id="ac_styles_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Accordion Styles',wpshopmart_accordion_shortcode_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/soft.png'; ?>">
						<br>
						<img src="<?php echo wpshopmart_accordion_shortcode_directory_url.'tooltip/img/noise.png'; ?>">
					</div>
		    	</div>
		...
		<tr>
			<th scope="row"><label><?php _e('Page Scroll To Accordion',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch wpsm_off">
					<input type="radio" class="switch-input" name="acc_scroll" value="yes" id="enable_acc_scroll"   checked>
					<label for="enable_acc_scroll" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<input type="radio" class="switch-input" name="acc_scroll" value="no" id="disable_acc_scroll"  >
					<label for="disable_acc_scroll" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
		...
		<tr>
			<th scope="row"><label><?php _e('ON Hover Accordion ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<div class="switch wpsm_off">
					<input type="radio" class="switch-input" name="acc_hover" value="yes" id="enable_acc_hover"   checked>
					<label for="enable_acc_hover" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<input type="radio" class="switch-input" name="acc_hover" value="no" id="disable_acc_hover"  >
					<label for="disable_acc_hover" class="switch-label switch-label-on"><?php _e('No',wpshopmart_accordion_shortcode_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>
				<a style="margin-top:10px" href="http://wpshopmart.com/plugins/accordion-pro/" target="_balnk">Available In Premium Version</a>
			</td>
		...
		<tr>
			<th scope="row"><label><?php _e('Open Close Icon',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
			<td>
				<img class="wpsm_img_responsive"  src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/snap-1.png'; ?>" />
				<a style="margin-top:10px" href="http://wpshopmart.com/plugins/accordion-pro/" target="_balnk">Available In Premium Version</a>
			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php _e('Content Animation ',wpshopmart_accordion_shortcode_text_domain); ?></label></th>
