<?php
if(isset($PostID) && isset($_POST['accordion_shortcode_setting_save_action'])) {
			...
			$Accordion_Shortcode_Settings_Array = serialize( array(
			...
			update_post_meta($PostID, 'Accordion_Shortcode_Settings', $Accordion_Shortcode_Settings_Array);
		}
