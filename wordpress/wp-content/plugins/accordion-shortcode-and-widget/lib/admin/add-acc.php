<div style=" overflow: hidden;padding: 10px;">
	...
	<h3><?php _e('Add Accordion',wpshopmart_accordion_shortcode_text_domain); ?></h3>
	<input type="hidden" name="ac_sh_save_data_action" value="ac_sh_save_data_action" />
	<ul class="clearfix" id="accordion_panel">
	<?php
			$i=1;
			$accordion_data = unserialize(get_post_meta( $post->ID, 'wpsm_accordion_shortcode_data', true));
			$TotalCount =  get_post_meta( $post->ID, 'wpsm_accordion_shortcode_count', true );
			if($TotalCount) 
			{
				if($TotalCount!=-1)
				{
					foreach($accordion_data as $accordion_single_data)
					{
						...
						<li class="wpsm_ac-panel single_acc_box" >
							<span class="ac_label"><?php _e('Accordion Title',wpshopmart_accordion_shortcode_text_domain); ?></span>
							...
							<span class="ac_label"><?php _e('Accordion Description',wpshopmart_accordion_shortcode_text_domain); ?></span>
							...
							<span class="ac_label"><?php _e('Accordion Icon',wpshopmart_accordion_shortcode_text_domain); ?></span>
							...
							<span class="ac_label"><?php _e('Display Above Icon',wpshopmart_accordion_shortcode_text_domain); ?></span>
...
<a class="wpsm_ac-panel add_wpsm_ac_new" id="add_new_ac" onclick="add_new_accordion()"   >
	<?php _e('Add New Accordion', wpshopmart_accordion_shortcode_text_domain); ?>
</a>
<a  style="float: left;padding:10px !important;background:#31a3dd;" class=" add_wpsm_ac_new delete_all_acc" id="delete_all_acc"    >
	...
	<span style="display:block"><?php _e('Delete All',wpshopmart_accordion_shortcode_text_domain); ?></span>
</a>
<div style="clear:left;"></div>
<h1>Get Support Help Here</h1>
<h3>If You have any issue then please ask us any time</h3>
<a href="https://wordpress.org/support/plugin/accordion-shortcode-and-widget" target="_blank" class="button button-primary button-hero ">Get Support</a>
<br> <br>
