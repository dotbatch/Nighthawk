...
if( ! class_exists( 'Conductor_Admin_Help' ) ) {
	final class Conductor_Admin_Help {
		...
		public function admin_menu() {
			...
			self::$sub_menu_page = add_submenu_page( $conductor_admin_options_menu_page, __( 'Help', 'conductor' ), __( 'Help', 'conductor' ), 'manage_options', 'conductor-help', array( $this, 'render' ) );
		...
		function admin_enqueue_scripts( $hook ) {
			...
			if ( strpos( $hook, 'conductor-help' ) === false )
				return false;
