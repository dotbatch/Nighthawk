...
function conductor_get_template_part( $slug, $name = '', $data = array(), $wp_globals = false, $require_once = false ) {
	...
	$template = apply_filters( 'conductor_get_template_part', $template, $slug, $name );
...
function conductor_is_active_sidebar( $sidebar, $content_layout = false ) {
	...
	// TODO: this should change to conductor_is_active_sidebar
	return apply_filters( 'conductor_is_sidebar_active', $active_sidebar, $sidebar, $content_layout );
}
