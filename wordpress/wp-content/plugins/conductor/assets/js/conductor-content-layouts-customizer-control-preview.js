/**
 * Conductor Content Layouts Theme Customizer Control Preview (used only in the previewer of the Customizer)
 */
...
( function ( wp, $ ) {
		...
		init: function () {
			var self = this,
				...
				conductor_ui = {
					...
					/*controls:
						'<section class="conductor-ui wp-core-ui conductor-ui-core conductor-cf">' +
							'<section class="conductor-ui-inner conductor-cf">' +
					...
					widget_edit_buttons: {
						before: {
							title: '<section class="conductor-ui conductor-ui-widget conductor-cf">' +
								'<span class="conductor-ui-button conductor-button conductor-edit-widget" title="Customize this Widget">' +
									'<span class="dashicons dashicons-edit"></span>' +
								'</span>' +
							'</section>',
							no_title: '<section class="conductor-ui conductor-ui-widget conductor-ui-widget-no-title conductor-cf">' +
								'<span class="conductor-ui-button conductor-button conductor-edit-widget" title="Customize this Widget">' +
									'<span class="dashicons dashicons-edit"></span>' +
								'</span>' +
							'</section>'
						...
						after:
							'<section class="conductor-ui conductor-ui-widget conductor-ui-widget-last conductor-cf">' +
								'<span class="conductor-ui-button conductor-button conductor-edit-widget" title="Customize this Widget">' +
								'<span class="dashicons dashicons-edit"></span>' +
								'</span>' +
							'</section>'
	...
	// Document ready
	$( function () {
		var settings = window.conductorOptions;
