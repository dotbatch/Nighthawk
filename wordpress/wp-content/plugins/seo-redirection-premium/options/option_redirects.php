        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <?php
                    ...
                    $where="where cat='link' and blog='" . get_current_blog_id() . "' ";
