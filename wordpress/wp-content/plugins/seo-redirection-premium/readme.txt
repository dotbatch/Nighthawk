...
== Description ==
By this plugin you can build redirects easily for your site, you can set up all types of redirectoin including 301,302 or 307 redirect, you can also monitor 404 error pages and redirect them in one mouse click, we concentrated on simplicity in this plugin to meet all user levels.
