...
class MotorCalendar_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'Motor Events Calendar', 'motor' ),
			array(
		...
		load_plugin_textdomain( 'motor', false, basename( dirname( __FILE__ ) ) . '/languages' );
    ...
    public function widget( $args, $instance ) {    
		...
		?>
			...
			while ($events_query->have_posts()) : $events_query->the_post();
				$events_date = vp_metabox('motor_meta_events.events_date');
